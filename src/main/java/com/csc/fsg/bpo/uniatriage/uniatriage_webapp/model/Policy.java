...
@GeneratedValue(strategy=GenerationType.AUTO)
	...
	@ManyToMany
	@JoinTable(name = "policy_agent", schema = "cyberlife", joinColumns = @JoinColumn(name = "policy_id")
...
CREATE TABLE POLICY (
		...
		LAST_ACTG_ACTIVITY_DATE DATE, 
		CONTRACT_ACTIVITY_DATE DATE, 
		...
		ISWL_IND SMALLINT, 
		MARKET_VALUE_ADJUSTMENT_AMOUNT DECIMAL(14 , 2), 
		FREE_WITHDRAWL_AMOUNT DECIMAL(14 , 2), 
		...
		BONUS_VESTED_ACCOUNT_VALUE DECIMAL(14 , 2), 
		BONUS_NONVESTED_ACCOUNT_VALUE DECIMAL(14 , 2), 
		BONUS_TOTAL_ACCOUNT_VALUE DECIMAL(14 , 2)
	)
	ORGANIZE BY ROW
	DATA CAPTURE NONE 
	COMPRESS NO;

ALTER TABLE POLICY ADD CONSTRAINT IDX_POLICY_PK PRIMARY KEY
	(POLICY_ID);
